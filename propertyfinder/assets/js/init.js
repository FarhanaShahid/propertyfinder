...
================================================== */
	REAL.catMenu = function () {
	    $(".category-toggle").click(function () {
	        $(".categorywrapper").slideToggle();
	        return false;
	    });
	    $(window).resize(function () {
	        if ($(".category-toggle").hasClass("opened")) {
	            $(".categorywrapper").css("display", "block");
	        }
	        else {
	            $(".category-toggle").css("display", "none");
	        }
	    });
	}
/* ==================================================
...
================================================== */
	REAL.FlexSlider = function() {
		$('.flexslider').each(function(){
				...
				sliderSpeed = sliderInstance.attr("data-speed") ? sliderInstance.attr("data-speed") : "8000",
