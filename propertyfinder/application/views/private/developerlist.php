                    ...
                    <div class="col-md-12">
                        <div class="page registration-page">
                            ...
                            <table rules="rows" style="border:1px solid:#000; width=100%; overflow:auto">
                                ...
                                <thead>
                                    <tr>
                                        <th><font size="6">Developer</font></th>
                                        <th><font size="6">Subscription</font></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php foreach ($sub as $row) {?>
                                    <tr id="<?php echo $row->id ?>">
                                        <td><a href="/propertyfinder/home/developerinfo?did=<?php echo $row->id ;?>"><font size="4"><?php echo $row->username ?></font></a></td>
                                        
                                        <td><button class="sub" onclick="window.location='/propertyfinder/subscription/removesubscription?did=<?php echo $row->id;?>'">Unsubscribe</button></td>
                                    </tr>
                                    <?php }?>
                                </tbody>
                            </table>
                            ...
                            <table rules="rows" style="border:1px solid:#000; width=100%; overflow:auto">
                                ...
                                <tbody>
                                    ...
                                    <tr id="<?php echo $row->id ?>">
                                        ...
                                        <td><button class="sub" onclick="window.location='/propertyfinder/subscription/addsubscription?did=<?php echo $row->id;?>'">Subscribe</button></td>
                                    </tr>
                                    <?php }?>
                                </tbody>
                            </table>
