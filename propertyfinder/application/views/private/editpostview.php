    ...
    <div class="main" role="main">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9">
                <form action="/propertyfinder/home/editpost?pid=<?php echo $propertyId?>" class="form-horizontal" role="form" method="post" >
                <div class="page registration-page">
                    ...
                    <fieldset>
                        <legend>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input class="form-control input-md" data-val="true" id="Price" name="Price" type="text" value="<?php echo $price;?>" />                        
                    ...
                    <fieldset>
                            ...
                            <div class="col-sm-4">
                                ...
                                <span class="input-group-addon" id="basic-addon1"><?php echo $sizeIn; ?></span>
                                <input class="form-control input-md" data-val="true"  id="Size" name="Size" type="text" value="<?php echo $size;?>" />       
                                </div>                 
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            <div class="col-sm-4">
                                <textarea rows="12" cols="100" id="Description" name="Description" type="text" value=""><?php echo $description;?></textarea>
                            </div>
                        </div>
