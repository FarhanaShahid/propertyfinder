...
<div class="main-menu-wrapper">
    ...
    <div class="site-showcase">
       <!-- <div class="slider-mask overlay-transparent hidden-xs"></div>-->
        <!-- Start Hero Slider -->
        <div class="hero-slider flexslider clearfix hidden-xs" data-autoplay="yes" data-pagination="no" data-arrows="yes" data-style="fade" data-pause="yes">
            <!-- <ul class="slides">
                <li class="parallax" style="background-image:url(../images/background.jpg);">
                </li>
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
      <img src="/propertyfinder/assets/images/8.png" alt="Chania">
    </div>

    <div class="item">
      <img src="/propertyfinder/assets/images/4.jpg" alt="Chania">
    </div>

    <div class="item">
      <img src="/propertyfinder/assets/images/6.jpg" alt="Flower">
    </div>

    <div class="item">
      <img src="/propertyfinder/assets/images/7.jpg" alt="Flower">
    </div>
  </div>
  ...
  <a class="right carousel-control" href="#myCarousel" role="button" data-slide="next">
    ...
    <span class="sr-only">Next</span>
        ...
        <!-- End Hero Slider -->
        <div class="homePagePromoText hidden-xs">
            <h1>PROPERTY FINDER</h1>
        </div>

        <!-- Links only for mobile devices -->
        <div class="site-search-module visible-xs">
    <div class="container">
        <div class="site-search-module-inside mobile-top-links">
            <div class="row">
                <div class="col-md-6">
                    <button class="btn btn-primary btn-block btn-lg" onclick="location.href='/en/selectpropertytype'">
                        <i class="fa fa-plus-circle"></i>
                        Post Your Ads
                    </button>
                </div>
                <div class="col-md-6">
                    <button class="btn btn-primary btn-block btn-lg" style="margin-bottom: 0" onclick="location.href='/Blog/addblog'">
                        <i class="fa fa-pencil-square-o"></i>
                        Post Your Requirement
                    </button>
                </div>
