...
<html >
<head>
    <title>Edit Account | propertyfinder.com</title>
...
<form action="/propertyfinder/index.php/home/editCompany" class="form-horizontal" role="form" method="post" >    <div class="page registration-page">
        ...
        <div class="page-body"> 
                ...
                <fieldset>
                    <legend>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input class="form-control input-md" id="Address" name="Address" type="text" value="<?php echo $address  ;?>" />  
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input class="form-control input-md" id="Address" name="Location" type="text" value="<?php echo $location ;?>" />  
                ...
                <fieldset>
                    <legend>
                        Change Current Contact Information
                    </legend>
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <div class="input-group">
                                    ...
                                    <input class="form-control input-md" id="Mobile" name="Mobile" type="text" value=<?php echo $contact ;?> />
                                </div>
            ...
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input class="form-control input-md" id="Password" name="Password" type="password" value="<?php echo $password ;?>"/>                        
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input class="form-control input-md" id="ConfirmPassword" name="ConfirmPassword" type="password" value="<?php echo $password ;?>" />                        
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input class="form-control input-md" id="Phone" name="Phone" type="text" value="<?php echo $phone  ;?>" />  
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <span class="input-group-addon" id="basic-addon1">880</span>
                        <input class="form-control input-md" id="Fax" name="Fax" type="text" value="<?php echo $fax ;?>" />
                    </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input class="form-control input-md" id="Web" name="Web" type="text" value="<?php echo $web  ;?>" />  

                    <span class="field-validation-valid help-block" data-valmsg-for="Web" data-valmsg-replace="true"></span>
