...
<html >
<head>
    <title>Register  |  propertyfinder.com</title>
...
<form action="/propertyfinder/registration/register" class="form-horizontal" role="form" method="post" >    <div class="page registration-page">
        ...
        <div class="page-body">
                    ...
                    <div class="col-md-4" id="Individual">
                        <div class="checkbox">
                            <label for="Individual">
                                <input data-val="true" data-val-required="&#39;Individual&#39; must not be empty." id="Individual" name="Individual" type="checkbox" value="accepted"/>
                                Individual
                            </label>
                        </div>
                    </div>
            ...
            <fieldset>
                <div class="form-group">
                    <div class="col-md-4" id="Company">
                        ...
                        <div class="checkbox">
                            <label for="Company">
                                <input data-val="true" data-val-required="&#39;Company&#39; must not be empty." id="Company" name="Company" type="checkbox" value="accepted"/>
                                Company
                            </label>
            ...
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input class="form-control input-md" data-val="true" data-val-required="Name is required." id="Name" name="Name" type="text" value="" />                        
                ...
                <div class="form-group">
                    ...
                    <span class="required">*</span>
                    <div class="col-md-4">
                        <input class="form-control input-md" data-val="true" data-val-email="Wrong email" data-val-required="Email is required." id="Email" name="Email" type="text" value="" />                        
                ...
                <fieldset>
                    <legend>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input class="form-control input-md" id="Address" name="Location" type="text" value="" />  
                ...
                <fieldset>
                    <legend>
                        ...
                        <div class="form-group">
                            <label class="col-md-4 control-label" for="Mobile">Phone number:</label>
<span class="required">*</span>                            <div class="col-md-4">
                                <div class="input-group">
                                    <span class="input-group-addon" id="basic-addon1">880</span>
                                    <input class="form-control input-md" data-val="true" data-val-length="Mobile number is not valid" data-val-length-max="10" data-val-length-min="10" data-val-required="Mobile number is required" id="Mobile" name="Mobile" type="text" value="" />
                                </div>
            ...
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <span class="required">*</span>
                    <div class="col-md-4">
                        <input class="form-control input-md" data-val="true" data-val-length="The password should have at least 6 characters." data-val-length-max="15" data-val-length-min="6" data-val-required="Password is required." id="Password" name="Password" type="password" />                        
                ...
                <div class="form-group">
                    ...
                    <span class="required">*</span>
                    <div class="col-md-4">
                        <input class="form-control input-md" data-val="true" data-val-equalto="The password and confirmation password do not match." data-val-equalto-other="*.Password" data-val-required="Password is required." id="ConfirmPassword" name="ConfirmPassword" type="password" />                        
