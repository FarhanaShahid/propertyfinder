            ...
            <div class="row">
                ...
                <div class="page registration-page">
                    ...
                    <div class="form-fields">
                        ...
                        <table style="border:1px solid:#000; width=100%; overflow:auto">
                            <col width="800">
                            <tbody>
                            <tr><font size="4">Address: </font><font size="3"><?php echo $address; echo " ,"; echo $location;?></font></tr>
                            <br>
                            <tr><font size="4">Email: </font><font size="3"><?php echo $email; ?></font></tr>
                            <br>
                            <tr><font size="4">Contact: </font><font size="3"><?php echo $contact; echo " ," ; echo $phone ; ?></font></tr>
                            <br>
                            <tr><font size="4">Fax: </font><font size="3"><?php echo $fax; ?></font></tr>
                            <br>
                            <tr><font size="4">Website: </font><font size="3"><a href="<?php echo $web?>"><font size="3">Visit our website</font></a></tr>
                            </tbody>
                        </table>
                    </div>
                </div>
